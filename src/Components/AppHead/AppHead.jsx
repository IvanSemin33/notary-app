...
const styles = {
  ...
  appBar: {
    width: '100%',
    position: "static",
    background: ' linear-gradient(to right, rgba(255,255,255,1) 0%, rgba(185,221,215,1) 19%, rgba(4,133,112,1) 68%, rgba(4,133,112,1) 98%)',
  }
};
                            ...
                            <Grid container 
                                ...
                                <Grid item align="center" xs={9}>
                                    ...
                                    >
                                        ...
                                        <Grid item>
                                            <Typography variant="h6">
                                                <a style={{color: "black"}} href="https://goo.gl/maps/rkWE6jhzDBXGsXQ36">606025, г. Дзержинск, бул. Мира, д. 29</a>
                                            </Typography>
                                        </Grid>
                                    </Grid>   
                                </Grid>
